...
/*   Updated: 2022/08/29 20:20:04 by hannkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount) {
	...
	std::cout << "Trap " << name_ << " takes damage " << amount << " points" << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount) {
	...
	--energy_point_;
	hit_point_ += amount;
	std::cout << "Trap " << name_ << " is repaired " << amount << " points" << std::endl;
}
